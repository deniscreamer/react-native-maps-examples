...
Для отрисовки трека на карте необходимо иметь массив точек по типу LatLng и воспользоваться компонентом PolyLine
...
![react-native-maps-examples](https://s4.gifyu.com/images/ezgif-7-9caaeef26060.gif)
